...
it('detects issues in the given directory of classes', function (): void {
    ...
    expect($issues)->toHaveCount(16)
        ...
        ->and($issues[6]->misspelling->suggestions)->toBe([
            ...
            'type',
            'topi',
        ])->and($issues[7]->file)->toEndWith('tests/Fixtures/ClassesToTest/FolderThatShouldBeIgnored/ClassWithTypoErrors.php')
        ->and($issues[7]->line)->toBe(9)
        ->and($issues[7]->misspelling->word)->toBe('properyt')
...
it('detects issues in the given directory of classes, but ignores the whitelisted words', function (): void {
    ...
    expect($issues)->toHaveCount(12)
        ...
        ->and($issues[5]->line)->toBe(12)
        ->and($issues[5]->misspelling->word)->toBe('erorr')
        ->and($issues[5]->misspelling->suggestions)->toBe([
            'error',
            'errors',
            'Orr',
        ...
        ->and($issues[6]->misspelling->suggestions)->toBe([
            ...
            'spieling',
            'spellings',
        ])->and($issues[7]->file)->toEndWith('tests/Fixtures/ClassesToTest/TraitWithTypo.php')
        ...
        ->and($issues[11]->line)->toBe(10)
        ->and($issues[11]->misspelling->word)->toBe('tst')
        ->and($issues[11]->misspelling->suggestions)->toBe([
            'test',
            'tat',
            'ST',
...
it('detects issues in the given directory of classes, but ignores the whitelisted directories', function (): void {
    ...
    expect($issues)->toHaveCount(15)
        ...
        ->and($issues[12]->misspelling->word)->toBe('properyt')
        ->and($issues[12]->misspelling->suggestions)->toBe([
            'property',
            'propriety',
            'properer',
        ...
        ->and($issues[14]->line)->toBe(10)
        ->and($issues[14]->misspelling->word)->toBe('tst')
...
it('detects issues in the given directory of enums', function (): void {
    ...
    expect($issues)->toHaveCount(11)
        ...
        ->and($issues[5]->file)->toEndWith('tests/Fixtures/EnumsToTest/FolderThatShouldBeIgnored/EnumWithTypoErrors.php')
        ->and($issues[5]->line)->toBe(9)
...
it('detects issues in the given directory of enums, but ignores the whitelisted directories', function (): void {
    ...
    expect($issues)->toHaveCount(10)
        ...
        ->and($issues[5]->file)->toEndWith('tests/Fixtures/EnumsToTest/UnitEnumWithTypoErrors.php')
        ->and($issues[5]->line)->toBe(20)
        ->and($issues[5]->misspelling->word)->toBe('spellling')
        ->and($issues[5]->misspelling->suggestions)->toBe([
            'spelling',
            'spilling',
